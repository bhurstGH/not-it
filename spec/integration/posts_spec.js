...
describe("routes : posts", () => {
            ...
            it("should not create a new post", (done) => {
                const options = {
                    ...
                    form: {
                        ...
                        body: "Without a doubt my favorite things to do besides watch paint dry!",
                    }
                };
    ...
    describe("signed in users performing CRUD actions for Post", () => {
        ...
        describe("admin users performing CRUD actions", () => {
                    ...
                    request.post(options, (err, res, body) => {
                        Post.findOne({ where: { title: "Watching snow melt" } })
                            .then((post) => {
                                ...
                                expect(post.body).toBe("Without a doubt my favorite things to do besides watch paint dry!");
        ...
        describe("members performing CRUD actions", () => {
            ...
            describe("POST /topics/:topicId/posts/:id/destroy", () => {
                ...
                it("should delete the post if member is the owner", (done) => {
                    expect(this.post.id).toBe(1);
            ...
            describe("GET /topics/:topicId/posts/:id/edit", () => {
                ...
                it("should render a view with an edit post form if member is the owner", (done) => {
                    expect(this.post.userId).toBe(this.user.id);
                    request.get(`${base}/${this.topic.id}/posts/${this.post.id}/edit`, (err, res, body) => {
                        expect(err).toBeNull();
                        expect(body).toContain("Edit Post");
            ...
            describe("POST /topics/:topicId/posts/:id/update", () => {
                ...
                it("should update the post with the given values if member is the owner", (done) => {
                    expect(this.post.userId).toBe(this.user.id);
                    const options = {
                        url: `${base}/${this.topic.id}/posts/${this.post.id}/update`,
                        form: {
